...
class AccountPayment(models.Model):
    ...
    def compute_account_payable_or_receivable(self):
        # Odoo 17 removed `account_internal_type`; account type lives on account.
        ...
        for payment in self:
            ...
            payment.account_payable_or_receivable = entries_lines[:1].id
    ...
    account_payable_or_receivable = fields.Many2one(
        'account.move.line',
        compute="compute_account_payable_or_receivable",
        store=True,
    )
