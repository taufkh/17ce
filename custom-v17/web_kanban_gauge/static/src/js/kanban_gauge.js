/** @odoo-module **/
/**
 * web_kanban_gauge — Gauge field widget
 * Migrated from v14 AbstractField.extend() → v16 OWL Component.
 * Chart.js v3 API: tooltips→plugins.tooltip, cutoutPercentage→cutout, title→plugins.title
 */
...
export class GaugeWidget extends Component {
    static template = xml`
        <div class="oe_gauge" t-att-style="props.style" style="position:relative;">
            <canvas t-ref="canvas"/>
...
// force:true overrides Odoo 16 built-in gauge if present
registry.category("fields").add("gauge", GaugeWidget, { force: true });
