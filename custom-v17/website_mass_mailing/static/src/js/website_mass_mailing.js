...
legacyDefine('mass_mailing.website_integration', function (require) {
"use strict";
...
publicWidget.registry.subscribe = PublicWidgetBase.extend({
...
publicWidget.registry.newsletter_popup = PublicWidgetBase.extend({
