...
legacyDefine('website_sale_comparison.comparison', function (require) {
'use strict';
...
// in website_sale.js
var ProductComparison = PublicWidgetBase.extend(VariantMixin, {
...
publicWidget.registry.ProductComparison = PublicWidgetBase.extend({
