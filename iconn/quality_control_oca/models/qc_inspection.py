...
class QcInspection(models.Model):
    ...
    checklist_attachment = fields.Binary(string="Checklist Document", copy=False, attachment=True)
    checklist_attachment_filename = fields.Char(string="Checklist Document Filename", copy=False, tracking=True)
    ...
    def action_confirm(self):
        for inspection in self:
            ...
            if inspection.test.required_checklist and not inspection.checklist_attachment:
                raise exceptions.UserError(
                    _(
                        "You must attach the checklist document "
                        "before confirming the inspection."
                    )
                )
